...
def plot_digerleri_xt(df1, df2, df3, df4, title, mode):
    ...
    ax1.set_title("Ham Günlük Altimetri Verileri", fontsize = 12)
    ax2.set_title("Ham Günlük Altimetri Verilerinin Detrend Değerleri", fontsize=12)
    ax3.set_title("IQR Sonrası Günlük Altimetri Verileri", fontsize=12)
    ax4.set_title("IQR Sonrası Günlük Altimetri Verilerinin Detrend Değerleri", fontsize=12)
    ax5.set_title("Aylık Altimetri Verileri", fontsize=12)
    ax6.set_title("Aylık Altimetri Verilerinin Detrend Değerleri", fontsize=12)
    ax7.set_title("IQR Sonrası Aylık Altimetri Verileri", fontsize=12)
    ax8.set_title("IQR Sonrası Aylık Altimetri Verilerinin Detrend Değerleri", fontsize=12)
