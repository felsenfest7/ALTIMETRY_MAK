...
grafikler = pf.plot_digerleri_tudes(df_15dk_merged_iqr[0], df_15dk_merged_iqr[1], df_saatlik_iqr[0], df_saatlik_iqr[1], df_gunluk_iqr[0], df_gunluk_iqr[1], df_aylik_iqr[0], df_aylik_iqr[1], "İğneada")
df_ekksa_grafik = pf.plot_ekksa_tudes(df_ekksa[1], "İğneada", df_ekksa[2], df_ekksa[3], 2018, 6, 1, 0.89)
