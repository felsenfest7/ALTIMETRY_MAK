...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Erdek (Uzak)")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Erdek (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2018, 5, 1, 37.894)
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Erdek (Yakın)")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Erdek (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2018, 5, 1, 38.21)
