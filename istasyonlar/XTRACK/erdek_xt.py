...
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Erdek (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2018, 5, 1, 37.894, "LRM")
...
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Erdek (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2018, 5, 1, 38.21, "LRM")
