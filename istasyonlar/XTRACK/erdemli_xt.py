...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Erdemli (Uzak)")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Erdemli (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2018, 5, 1, 24.78)
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Erdemli (Yakın)")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Erdemli (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2018, 5, 1, 25.29)
