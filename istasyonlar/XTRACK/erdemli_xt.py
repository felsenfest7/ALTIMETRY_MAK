...
data = "/home/furkan/deus/ALTIMETRY_2/DATA/XTRACK_DATA/MEDSEA/ctoh.sla.ref.TP+J1+J2+J3.medsea.068.nc"
dataset = fxt.read_xt(data, 36.5637203, 34.25539255, 0.10)

#Ardından kıyıya uzak ve yakın iki XTRACK altimetri ölçme noktasının belirlenmesi
dataset1 = dataset[dataset["points_numbers"] == 45]     #kıyıya uzak olan
dataset2 = dataset[dataset["points_numbers"] == 46]     #kıyıya yakın olan
...
dataset1_pre_ekksa = fxt.pre_ekksa(dataset1_aylık[1], "2003-05-01", "2019-11-01")
...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Erdemli (Uzak)", "LRM")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Erdemli (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2018, 5, 1, 24.78, "LRM")
...
dataset2_pre_ekksa = fxt.pre_ekksa(dataset2_aylık[1], "2003-05-01", "2019-11-01")
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Erdemli (Yakın)", "LRM")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Erdemli (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2018, 5, 1, 25.29, "LRM")
