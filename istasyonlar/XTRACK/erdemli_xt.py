...
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Erdemli (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2020, 6, 1, 24.78, "LRM")
...
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Erdemli (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2020, 6, 1, 25.29, "LRM")
