...
data = "/home/furkan/deus/ALTIMETRY_2/DATA/XTRACK_DATA/MEDSEA/ctoh.sla.ref.TP+J1+J2+J3.medsea.007.nc"
dataset = fxt.read_bozuk_xt(data, 36.83042146, 0.10, "ANTALYA", "xt")

#Bozuk veriden elle çıkarmaların yapılması
dff = pd.read_excel("/home/furkan/deus/ALTIMETRY_2/SONUÇLAR/ANTALYA/antalya_xt_bozuk.xlsx", index_col = 0)
dff.drop([123616,123837, 124689, 124910], axis=0, inplace=True)
...
dataset1 = dff[dff["points_numbers"] == 116]     #kıyıya uzak olan
dataset2 = dff[dff["points_numbers"] == 117]     #kıyıya yakın olan
...
dataset1_pre_ekksa = fxt.pre_ekksa(dataset1_aylık[1], "1998-12-01", "2023-01-01")
...
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Antalya (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2020, 6, 1, 25.307, "LRM")
...
dataset2_pre_ekksa = fxt.pre_ekksa(dataset2_aylık[1], "1998-12-01", "2023-01-01")
...
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Antalya (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2020, 1, 1, 25.83, "LRM")
...
dataset2_distance = fxt.mesafe_hesapla(36.83042146, 30.60868263, dataset2.lat.mean(), dataset2.lon.mean())
