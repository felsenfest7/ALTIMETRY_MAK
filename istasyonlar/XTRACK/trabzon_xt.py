...
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Trabzon (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2018, 6, 1, 23.79, "LRM")
...
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Trabzon (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2018, 6, 1, 24.363, "LRM")
