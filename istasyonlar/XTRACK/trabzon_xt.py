...
dataset1_pre_ekksa = fxt.pre_ekksa(dataset1_aylık[1], "2002-07-01", "2023-11-01")
...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Trabzon (Uzak)", "LRM")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Trabzon (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2020, 6, 1, 23.79, "LRM")
...
dataset2_pre_ekksa = fxt.pre_ekksa(dataset2_aylık[1], "2002-07-01", "2023-11-01")
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Trabzon (Yakın)", "LRM")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Trabzon (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2020, 6, 1, 24.363, "LRM")
