...
data = "/home/furkan/deus/ALTIMETRY_2/DATA/XTRACK_DATA/MEDSEA/ctoh.sla.ref.TP+J1+J2+J3.medsea.109.nc"
dataset = fxt.read_xt(data, 38.76960155, 26.72214568 , 0.99)

#Ardından kıyıya uzak ve yakın iki XTRACK altimetri ölçme noktasının belirlenmesi
dataset1 = dataset[dataset["points_numbers"] == 103]     #kıyıya yakın olan
dataset2 = dataset[dataset["points_numbers"] == 104]     #kıyıya uzak olan
...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Menteş (Yakın)")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Menteş (Yakın)", dataset1_ekksa[2], dataset1_ekksa[3], 2018, 5, 1, 38.96)
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Menteş (Uzak)")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Menteş (Uzak)", dataset2_ekksa[2], dataset2_ekksa[3], 2018, 5, 1, 38.82)
