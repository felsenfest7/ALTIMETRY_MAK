...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Marmara Ereğlisi (Uzak)")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Marmara Ereğlisi (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2018, 5, 1, 37.345)
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Marmara Ereğlisi (Yakın)")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Marmara Ereğlisi (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2017, 6, 1, 37.57)
