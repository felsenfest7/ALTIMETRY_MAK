...
dataset1_pre_ekksa = fxt.pre_ekksa(dataset1_aylık[1], "2009-06-01", "2019-11-01")
...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Marmaris (Yakın)")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Marmaris (Yakın)", dataset1_ekksa[2], dataset1_ekksa[3], 2018, 11, 1, 23.725)
...
dataset2_pre_ekksa = fxt.pre_ekksa(dataset2_aylık[1], "2009-06-01", "2019-11-01")
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Marmaris (Uzak)")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Marmaris (Uzak)", dataset2_ekksa[2], dataset2_ekksa[3], 2018, 11, 1, 24.585)
