...
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Marmaris (Yakın)", dataset1_ekksa[2], dataset1_ekksa[3], 2018, 11, 1, 23.725, "LRM")
...
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Marmaris (Uzak)", dataset2_ekksa[2], dataset2_ekksa[3], 2018, 11, 1, 24.585, "LRM")
