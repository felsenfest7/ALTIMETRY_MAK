...
data = "/home/furkan/deus/ALTIMETRY_2/DATA/XTRACK_SAR_DATA/BSEA/ctoh.sla.ref.S3A.bsea.156.nc"
dataset = fxt.read_bozuk_xt(data, 42.00042146, 0.5, "SİNOP", "sar")

#Bozuk veriden elle çıkarmaların yapılması
dff = pd.read_excel("/home/furkan/deus/ALTIMETRY_2/SONUÇLAR/SİNOP/sinop_sar_bozuk.xlsx", index_col = 0)
...
dataset1 = dff[dff["points_numbers"] == 2]     #kıyıya uzak olan
dataset2 = dff[dff["points_numbers"] == 1]     #kıyıya yakın olan
...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Sinop (Uzak)", "SAR")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Sinop (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2022, 5, 1, 28.47, "SAR")
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Sinop (Yakın)", "SAR")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Sinop (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2022, 6, 1, 29.03, "SAR")
