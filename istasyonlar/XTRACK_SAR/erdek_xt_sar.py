...
dataset = fxt.read_bozuk_xt(data, 40.30042146, 0.5, "ERDEK", "sar")

#Bozuk veriden elle çıkarmaların yapılması
dff = pd.read_excel("/home/furkan/deus/ALTIMETRY_2/SONUÇLAR/ERDEK/erdek_sar_bozuk.xlsx", index_col = 0)
...
dataset2 = dff[dff["points_numbers"] == 3]     #kıyıya yakın olan
...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Erdek (Uzak)", "SAR")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Erdek (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2022, 7, 1, 38.89, "SAR")
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Erdek (Yakın)", "SAR")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Erdek (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2022, 7, 1, 38.93, "SAR")
