...
data = "/home/furkan/deus/ALTIMETRY_2/DATA/XTRACK_SAR_DATA/BSEA/ctoh.sla.ref.S3A.bsea.128.nc"
dataset = fxt.read_bozuk_xt(data, 41.80042146, 0.5, "İGNEADA", "sar")

#Bozuk veriden elle çıkarmaların yapılması
dff = pd.read_excel("/home/furkan/deus/ALTIMETRY_2/SONUÇLAR/İGNEADA/igneada_sar_bozuk.xlsx", index_col = 0)
...
dataset1 = dff[dff["points_numbers"] == 16]     #kıyıya uzak olan
dataset2 = dff[dff["points_numbers"] == 15]     #kıyıya yakın olan
...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "İğneada (Uzak)", "SAR")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "İğneada (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2022, 6, 1, 37.68, "SAR")
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "İğneada (Yakın)", "SAR")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "İğneada (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2022, 6, 1, 37.84, "SAR")

#Mesafeler ve koordinatlar
dataset1_distance = fxt.mesafe_hesapla(41.88890424, 28.02351594, dataset1.lat.mean(), dataset1.lon.mean())
dataset2_distance = fxt.mesafe_hesapla(41.88890424, 28.02351594, dataset2.lat.mean(), dataset2.lon.mean())
