...
data = "/home/furkan/deus/ALTIMETRY_2/DATA/XTRACK_SAR_DATA/MEDSEA/ctoh.sla.ref.S3A.medsea.156.nc"
dataset = fxt.read_bozuk_xt(data, 36.09619554, 0.5, "BOZYAZI", "sar")

#Bozuk veriden elle çıkarmaların yapılması
dff = pd.read_excel("/home/furkan/deus/ALTIMETRY_2/SONUÇLAR/BOZYAZI/bozyazi_sar_bozuk.xlsx", index_col = 0)
...
dataset1 = dff[dff["points_numbers"] == 67]     #kıyıya uzak olan
dataset2 = dff[dff["points_numbers"] == 68]     #kıyıya yakın olan
...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Bozyazı (Uzak)", "SAR")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Bozyazı (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2022, 7, 1, 26.94, "SAR")
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Bozyazı (Yakın)", "SAR")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Bozyazı (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2022, 5, 1, 27.56, "SAR")
