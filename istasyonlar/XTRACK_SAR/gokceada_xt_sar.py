...
dataset = fxt.read_bozuk_xt(data, 40.3587148, 1, "GOKCEADA", "sar")

#Bozuk veriden elle çıkarmaların yapılması
dff = pd.read_excel("/home/furkan/deus/ALTIMETRY_2/SONUÇLAR/GOKCEADA/gokceada_sar_bozuk.xlsx", index_col = 0)
...
dataset1 = dff[dff["points_numbers"] == 134]     #kıyıya uzak olan
dataset2 = dff[dff["points_numbers"] == 133]     #kıyıya yakın olan
...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Gökçeada (Uzak)", "SAR")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Gökçeada (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2022, 6, 1, 39.54, "SAR")
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Gökçeada (Yakın)", "SAR")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Gökçeada (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2022, 7, 1, 39.84, "SAR")
