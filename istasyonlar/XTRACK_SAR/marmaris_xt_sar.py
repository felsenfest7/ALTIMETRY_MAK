...
data = "/home/furkan/deus/ALTIMETRY_2/DATA/XTRACK_SAR_DATA/MEDSEA/ctoh.sla.ref.S3A.medsea.356.nc"
dataset = fxt.read_bozuk_xt(data, 36.74042146, 0.5, "MARMARİS", "sar")

#Bozuk veriden elle çıkarmaların yapılması
dff = pd.read_excel("/home/furkan/deus/ALTIMETRY_2/SONUÇLAR/MARMARİS/marmaris_sar_bozuk.xlsx", index_col = 0)
...
dataset1 = dff[dff["points_numbers"] == 89]     #kıyıya uzak olan
dataset2 = dff[dff["points_numbers"] == 90]     #kıyıya yakın olan
...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Marmaris (Uzak)", "SAR")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Marmaris (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2022, 7, 1, 23.44, "SAR")
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Marmaris (Yakın)", "SAR")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Marmaris (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2022, 7, 1, 24.46, "SAR")
