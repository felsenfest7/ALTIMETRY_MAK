...
dataset = fxt.read_bozuk_xt(data, 40.80042146, 1, "MARMARA_EREGLİSİ", "sar")

#Bozuk veriden elle çıkarmaların yapılması
dff = pd.read_excel("/home/furkan/deus/ALTIMETRY_2/SONUÇLAR/MARMARA_EREGLİSİ/marmara_ereglisi_sar_bozuk.xlsx", index_col = 0)
...
dataset1 = dff[dff["points_numbers"] == 10]     #kıyıya uzak olan
dataset2 = dff[dff["points_numbers"] == 11]     #kıyıya yakın olan
...
dataset1_grafikler = pf.plot_digerleri_xt(df1, df2, df3, df4, "Marmara Ereğlisi (Uzak)", "SAR")
dataset1_ekksa_grafik = pf.plot_ekksa_xt(df5, "Marmara Ereğlisi (Uzak)", dataset1_ekksa[2], dataset1_ekksa[3], 2022, 7, 1, 37.13, "SAR")
...
dataset2_grafikler = pf.plot_digerleri_xt(df6, df7, df8, df9, "Marmara Ereğlisi (Yakın)", "SAR")
dataset2_ekksa_grafik = pf.plot_ekksa_xt(df10, "Marmara Ereğlisi (Yakın)", dataset2_ekksa[2], dataset2_ekksa[3], 2022, 6, 1, 37.66, "SAR")
